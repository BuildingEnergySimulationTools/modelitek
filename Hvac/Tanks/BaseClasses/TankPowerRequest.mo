...
<p><b>TankPowerRequest (version découplée)</b></p>
<ul>
<li><b>Q_req_th</b>: besoin thermique brut (hystérésis + pertes + consigne), ne dépend pas du débit.</li>
<li><b>Q_req</b>: demande finale à la PAC, limitée par l’hydraulique (fonction du débit).</li>
<li><b>besoinON</b>: booléen indiquant si le ballon est en demande (sert à piloter pompes/vanne).</li>
</ul>
</body></html>")
  );
