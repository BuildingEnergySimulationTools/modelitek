...
model TemperatureLimits
  ...
  Modelica.Blocks.Interfaces.RealInput T_am "°C" annotation(
    Placement(transformation(extent = {{-120, 40}, {-100, 60}}), iconTransformation(origin = {0, 12}, extent = {{-120, 40}, {-100, 60}})));
  Modelica.Blocks.Interfaces.RealInput T_av "°C" annotation(
    Placement(transformation(extent = {{-120, 0}, {-100, 20}}), iconTransformation(origin = {0, 12}, extent = {{-120, 0}, {-100, 20}})));
  Modelica.Blocks.Interfaces.RealInput P_in "W" annotation(
    Placement(transformation(extent = {{-120, -40}, {-100, -20}}), iconTransformation(origin = {0, 12}, extent = {{-120, -40}, {-100, -20}})));
  Modelica.Blocks.Interfaces.RealOutput P_out "W limité" annotation(
    Placement(transformation(origin = {-140, -20}, extent = {{100, 0}, {120, 20}}), iconTransformation(origin = {-98, -14}, extent = {{100, 0}, {120, 20}})));
  Modelica.Blocks.Interfaces.BooleanOutput actif "true si PAC autorisée (dans les limites)" annotation(
    Placement(transformation(origin = {-140, -20}, extent = {{100, 40}, {120, 60}}), iconTransformation(origin = {-98, -14}, extent = {{100, 40}, {120, 60}})));
protected
...
// Limitation de puissance
  ...
  annotation(
    ...
    Documentation(info = "<html><head></head><body><!--StartFragment--><strong data-start=\"14\" data-end=\"118\"><code data-start=\"16\" data-end=\"23\">actif</code> vaut <code data-start=\"29\" data-end=\"35\">true</code> quand <em data-start=\"42\" data-end=\"50\">toutes</em> les températures amont et aval sont dans leurs plages autorisées.</strong><br data-start=\"118\" data-end=\"121\">
Sinon → <code data-start=\"129\" data-end=\"136\">false</code>.<!--EndFragment-->&nbsp;&nbsp;</body></html>"));
