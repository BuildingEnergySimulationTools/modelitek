...
elseif Statut_valeurs_Cop == 2 then 
 COP = 0.9 * combiTable2D.y;
  ...
  Icon(graphics = {Rectangle(origin = {0, 2}, fillColor = {0, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-100, 36}, {100, -36}}), Text(origin = {4, 75}, textColor = {0, 0, 255}, extent = {{-132, 31}, {132, -31}}, textString = "%name")}),
