...
model AffineEquationBlock
  Modelica.Blocks.Interfaces.RealInput T_amont(final unit = "K", displayUnit = "degC") "Set point for leaving fluid temperature at port b1" annotation(
    Placement(visible = true, transformation(origin = {-103, 7}, extent = {{-19, -19}, {19, 19}}, rotation = 0), iconTransformation(extent = {{-102, -78}, {-74, -50}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Division division annotation(
    Placement(visible = true, transformation(extent = {{116, -80}, {132, -64}}, rotation = 0)));
  ...
  Hvac.HeatPumps.BaseClasses.AffineEquationFlow data_pac(xA = -10 + 273.15, yA = 2.5, xB = 12 + 273.15, yB = 5.5, D = 1.6, time_data = 3600) annotation(
    Placement(visible = true, transformation(extent = {{-54, -2}, {-20, 32}}, rotation = 0)));
...
equation
  connect(division.y, P_elec) annotation(
    Line(points = {{133, -72}, {262, -72}}, color = {0, 0, 127}, smooth = Smooth.Bezier));
  connect(P_aval, division.u1) annotation(
    Line(points = {{-100, -66}, {104, -66}, {104, -67}, {114, -67}}, color = {0, 0, 127}));
  connect(T_amont, data_pac.T) annotation(
    Line(points = {{-103, 7}, {-74, 7}, {-74, 23}, {-52, 23}}, color = {0, 0, 127}));
  ...
  connect(data_pac.Debit, switch1.u1) annotation(
    Line(points = {{-24, 28}, {-2, 28}, {-2, 182}, {62, 182}}, color = {0, 0, 127}));
  ...
  connect(division.y, add.u2) annotation(
    Line(points = {{133, -72}, {142, -72}, {142, -48}, {44, -48}, {44, -32}, {52, -32}}, color = {0, 0, 127}));
  ...
  connect(data_pac.COP, division.u2) annotation(
    Line(points = {{-24, 3}, {18, 3}, {18, -77}, {114, -77}}, color = {0, 0, 127}));
  connect(data_pac.COP, COP) annotation(
    Line(points = {{-24, 3}, {-24, -92}, {-8, -92}}, color = {0, 0, 127}));
  annotation(
