...
model HeatingSetpointSimple
  ...
  Modelica.Blocks.Sources.RealExpression b(y = params.b) annotation(
    Placement(transformation(origin = {-221, 58}, extent = {{-15, -10}, {15, 10}})));
  ...
  Modelica.Thermal.HeatTransfer.Celsius.FromKelvin fromKelvin annotation(
    Placement(transformation(origin = {-246, 96}, extent = {{-10, -10}, {10, 10}})));
...
<p class=\"MsoNormal\"><br></p></div><div><p></p>

<!--EndFragment--></div></body></html>"));
end HeatingSetpointSimple;
